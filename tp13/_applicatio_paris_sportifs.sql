...
--
-- Hôte : localhost
-- Généré le : mer. 19 nov. 2025 à 13:00
...
--
-- Base de données : ` applicatio_paris_sportifs`
--
...
(1, ' PSG ', 'OM ', '2025-11-18 10:48:15', 1),
(2, 'Lakers ', 'Bulls ', '2025-11-18 10:49:16', 2),
(3, 'Nadal ', ' Federer ', '2025-11-18 10:49:16', 3);
...
(3, 'Idrissi', ' Karim', 'IdrissiKarim@gmail.com');
...
--
ALTER TABLE `gain`
  MODIFY `id_gain` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `pari`
  MODIFY `id_pari` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
ALTER TABLE `pari`
  ...
  ADD CONSTRAINT `pari_ibfk_2` FOREIGN KEY (`id_typepari`) REFERENCES `typepari` (`id_typepari`),
  ADD CONSTRAINT `pari_ibfk_3` FOREIGN KEY (`id_match`) REFERENCES `matchs` (`id_match`);
COMMIT;
